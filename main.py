...
# ----------------- Configuration -----------------
# Railway Dashboard -> Variables -> BOT_TOKEN se token uthayega
...
def init_db():
    ...
    # Safe column additions if migrating from an older DB
    ...
    # Daily Routine Checklist table (Resets at 11:58 PM)
    cursor.execute(
        """
...
# 1. End of Day (EOD) Review at 11:30 PM (23:30 IST)
async def end_of_day_review_job(context: ContextTypes.DEFAULT_TYPE):
    ...
    for uid in users:
        ...
        msg = (
            ...
            "Agar aaj ka target poora hua toh shabash! Achi neend lein aur kal subah naye targets set karein. 🛌"
        )
        try:
...
# 2. Daily Routine Checklist Auto-Reset at 11:58 PM (23:58 IST)
...
# 3. Daily Morning Briefing at 07:00 AM IST
...
async def restore_and_setup_jobs(application: Application):
    ...
    # 2. End of Day (EOD) Review at 11:30 PM (23:30 IST)
    ...
    # 3. Daily Routine Checklist Auto-Reset at 11:58 PM (23:58 IST)
    ...
    # 4. Daily Morning Briefing at 07:00 AM IST
...
def main():
    ...
    print("Bot is running with Streak, Formula Vault & 11:30 PM EOD Review...")
    app.run_polling()
